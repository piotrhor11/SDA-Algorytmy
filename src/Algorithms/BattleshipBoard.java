...
public class BattleshipBoard extends AbstractAlgorithm {
    ...
    private final char[] alphabet = {'A', 'B', 'C'};                //Zmienione w celach testowych
    ...
    public void runAlgorithm(String[] input) {
        ...
        if (Math.sqrt(size) % 1 == 0.0) {
            ...
            for (int i = 0; i < side; i++) {                    //ToCheck - nie wiem jak zautomatyzować tworzenie się odpowiednich konstrukcji if, myślałem o rekurencji ale trochę się to komplikuje
